...
export const translation = {
  ...
  mapSettings: {
    ...
    instructions: [
      "Pull on a character to drag it. Hold down ALT, press RMB and move the mouse to select players (all selected characters can be moved). When arrow mode is enabled, you can draw arrows by pressing RMB (start of arrow), then releasing RMB (end of arrow)",
      "Тяните за персонажа, чтобы перетащить его. Зажмите ALT, нажмите ПКМ и перемещайте мышь, чтобы выделять игроков (всех выделенных персонажей можно перемещать). Когда режим стрелок включен, можно рисовать стрелки нажимая ПКМ (начало стрелки), затем отпуская ПКМ (конец стрелки)",
    ],
  },
};
